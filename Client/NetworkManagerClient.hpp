// client's primary link to server
// handles communication with the server, sending packets and processing incoming packets
//manages the connection lifecycle, sends player input to server and receives game state from server
// sync input with server processing and measure network quality with round trip time and packet loss tracking
