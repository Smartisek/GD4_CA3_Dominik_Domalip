//bridge between player keyboard input and networked game actions, collects raw input and converts it into timestamped moves that ccan be sent to the server for replication
